    ...
    >
      ...
      <div className="shot-body">
        <aside className="side" aria-hidden="true">
          ...
          <a href="#" tabIndex={-1}>Overview</a>
          <a href="#" tabIndex={-1} className="on">Complaints</a>
          <a href="#" tabIndex={-1}>Vigilance cases</a>
          <a href="#" tabIndex={-1}>Trends</a>
          <a href="#" tabIndex={-1}>CAPA</a>
          <a href="#" tabIndex={-1}>Devices</a>
          <a href="#" tabIndex={-1}>Audit trail</a>
        </aside>
        ...
        <div className="main">
          ...
          <p className="sub">14 open complaints · 2 reportability decisions due this week · 0 breached</p>

          <div className="tbl">
            <div className="trh">
              <div>Record</div><div>Complaint</div><div>Regulatory clock</div><div>Stage</div><div>Owner</div>
            </div>
            ...
            <div className="tr">
              ...
              <div>
                ...
                <div className="d" style={{ marginTop: 4 }}>US · not on market</div>
              </div>
              <div><span className="pill p-amber">Reportability</span></div>
              ...
              <div className="next">
                ...
                <a className="btn btn-primary" href="#" tabIndex={-1}>Open decision</a>
              </div>
            </div>
            ...
            <div className="tr">
              ...
              <div><span className="pill p-amber">UK · 6 days left</span></div>
              <div><span className="pill p-mute">Investigation</span></div>
            ...
            <div className="tr">
              ...
              <div><span className="pill p-green">Not reportable · decided</span></div>
              <div><span className="pill p-mute">Investigation</span></div>
              <div className="own">V. Cuni</div>
            </div>
          </div>
