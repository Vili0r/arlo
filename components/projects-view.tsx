  ...
  const projects = [
    {
      ...
      repo: "Vili0r/CVForge",
      date: "Aug 11",
      details: "PMS Complaints System",
    },
    {
      id: "memo-website",
      title: "memo-wesbite",
      domain: "www.memonotes.app",
      href: "/capa",
      ...
      branch: "new design",
      repo: "Vili0r/memo-wasbite",
      date: "Feb 15",
      details: "CAPA Management",
    },
    {
      id: "my-spoons",
      title: "my-spoons",
      domain: "www.myspoonsjournal.com",
      href: "/audit-trail",
      iconBg: "bg-neutral-900 border border-neutral-800",
      iconText: "N",
      statusIcon: Activity,
      statusColor: "text-neutral-400",
      branch: "indexing page update",
      repo: "Vili0r/my-spoons",
      date: "12/4/25",
      details: "21 CFR Audit Trail",
    },
    {
      id: "arlo-quality-pms",
      title: "arlo-quality-pms",
      domain: `${orgSlug}.arlo.quality`,
      href: "/complaints",
      ...
      repo: `CAPAs: ${capaCount} • Audit Logs: ${auditLogCount}`,
      date: "Active",
      details: "ISO 13485 & FDA Validated",
    },
  ];
